...
class MigrationTests(unittest.TestCase):
        ...
        with tempfile.TemporaryDirectory() as temp_name:
            ...
            self.assertEqual(
                ...
                [
                    ...
                    "0015", "0016", "0017", "0018",
                    "0019", "0020", "0021", "0022", "0023", "0024", "0025", "0026", "0027", "0028", "0029", "0030", "0031", "0032", "0033"
                ]
            )
    ...
    def test_review_log_composite_index_migration_is_idempotent(self):
        with tempfile.TemporaryDirectory() as temp_name:
            temp_dir = Path(temp_name)
            database_file = temp_dir / "questions.db"
            engine = create_engine(sqlite_url(database_file))
            ...
            self.assertIn("ix_review_log_question_reviewed", indexes)
